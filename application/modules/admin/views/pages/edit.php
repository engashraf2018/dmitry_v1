											...
											<div class="tab-pane active" id="tab_5">
												<div class="portlet box blue ">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-gift"></i>Edit Pages </div>
													...
													<div class="portlet light bordered form-fit">
														...
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $dd?>admin/pages/edit_action" class="form-horizontal form-bordered"
															 method="post" enctype="multipart/form-data">
																<div class="form-body">
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-10">
																			<input value="<?=$title;?>" name="title" type="text" placeholder="Title" class="form-control" required>
																			<input type="hidden" name="id" value="<?=$id;?>">
																			<span class="help-block"> The Name Of Page </span>
																		</div>
																	</div>
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-10">
																			<textarea id="contents" name="contents" id="contents"><?=$content;?></textarea>
