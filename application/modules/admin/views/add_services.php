...
<form  method="post" action="services_action" id="myform"  enctype="multipart/form-data">
...
<label class="control-label" for="firstname" style=" direction:rtl; float:right;font-family: 'Droid Arabic Kufi', sans-serif;">الاسم</label> <input class="form-control" id="password" name="name" type="text" style="width:100%; text-align:right; direction:rtl" required/></div>



<div class="form-group">

<label class="control-label" for="firstname" style=" direction:rtl; float:right;font-family: 'Droid Arabic Kufi', sans-serif;">الرابط الخارجى</label> <input class="form-control" id="password" name="link" type="text" style="width:100%; text-align:right; direction:rtl"/></div>
...
<input type="submit" value="اضافة خدمة جديد" class="btn btn-primary fa fa-check-circle" id="Send"  style="font-family: 'Droid Arabic Kufi', sans-serif;">
