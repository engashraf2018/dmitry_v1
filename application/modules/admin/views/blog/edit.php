			...
			<div class="page-content-wrapper">
				<div class="page-content" style="min-height: 1261px;">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?=$dd.'admin/blog';?>">Blog List</a>
							<i class="fa fa-circle"></i>
						</li>
						<li>
												...
												<div class="portlet box blue ">
													...
													<div class="portlet light bordered form-fit">
														...
														<div class="portlet-body form">
															<!-- BEGIN FORM-->
															<form action="<?php echo $dd?>admin/blog/edit_action" class="form-horizontal form-bordered"
															 method="post" enctype="multipart/form-data">
																<div class="form-body">
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-10">
																			<input value="<?=$title;?>" name="title" type="text" placeholder="Name" class="form-control" required>
																			<input type="hidden" name="id" value="<?=$id;?>">
																			<span class="help-block"> The Name Of blog </span>
																		</div>
																	</div>
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		...
																		<div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																				<img src="<?=$dd?>design/apps/img/no_img.png" alt="" /> </div>
																		...
																		<div class="col-md-2">
																			...
																			<img src="<?php echo $dd.'site/ar/images/blog/'.$image;?>">
																			</div>
																		</div>
																	</div>
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-10">
																			<textarea class="form-control" rows="3" name="short_desc"><?=$short_desc;?></textarea>
																	...
																	<div class="form-group">
																		<div class="col-md-2"></div>
																		<div class="col-md-10">
																			<textarea id="description" name="description" id="description"><?=$description;?></textarea>
