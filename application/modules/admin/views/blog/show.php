			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">Blog List</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<span class="portlet-body">
									...
									<form action="<?php echo $dd?>admin/blog/delete" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input name="check[]" type="checkbox" class="checkboxes" value="<?=$data->id_blog;?>" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->title;?> </td>
												<td><span class="code_actvation-<?php echo $data->id_blog;?>"><?php echo $active;?></span>
												<a data-id="<?=$data->id_blog;?>" class="btn btn-xs purple edit" style="padding: 1px 0px;"><i class="fa fa-edit"></i></a>
												</td>
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo $dd?>admin/blog/edit?id=<?=$data->id_blog;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo $dd?>admin/blog/delete?id_blog=<?=$data->id_blog;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/blog/active") ?>',
		type: 'POST',
		data: data,				
