...
$(document).ready(function(e) {
    $(".change").click(function(e) {
		...
		$.ajax({
				url: '<?php echo $base_url?>home/slider_view',
                dataType:'json',
                data: data,	
				type:'POST',
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("<?php echo $base_url?>home/add_slider");
    });
                     ...
                     لا يوجد بيانات حاليا
						...
						foreach($results as $jobs){
							  ...
							  switch($view){
							    ...
							    $image=$jobs->img;
								 $img="../../site/ar/images/home_slider/".$image;    
						?>
 <tr>
...
<td class="center">
<a href="<?php echo $base_url?>home/delete_slider?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="<?php echo $base_url?>home/update_slider?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
