			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">City List</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('state',array('type'=>'2'))->result();
										if(count($tt)>0){
											...
											$country=$this->db->get_where('state',array('id_state'=>$parent_id))->result();
											if(count($country)>0){
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/update_city?id_type=<?php echo $data->id_state;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo base_url()?>admin/delete_city?id_type=<?php echo $data->id_state;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/check_view_city") ?>',
                type: 'POST',
                data: data,				
