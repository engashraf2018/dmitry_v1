...
<div class="tab-pane active" id="tab_5">
                                        <div class="portlet box blue ">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    <i class="fa fa-gift"></i>Add Country</div>
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo base_url()?>admin/country_action" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data">
                                                    <div class="form-body">
                                                        <div class="form-group">
														<div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="Country" class="form-control" name="id_country">
                                                        ...
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width:32px; height:32px;">
																				<img src="<?php echo base_url()?>site/ar/images/flag/flag.png" alt="" /> </div>
