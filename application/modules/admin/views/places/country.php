						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?php echo $base_url?>admin/delete_country" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<?php
										$tt=$this->db->get_where('country')->result();
										if(count($tt)>0){
                                            foreach($results as $data) {
												...
												$flag=$data->flag;
												$img="../site/ar/images/flag/".$flag; 
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input type="checkbox" class="checkboxes" value="<?=$data->id_country;?>" name="check[]" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->title;?> </td>
												<td><img src="<?php echo $img?>" style="width:32px;height:32px"></td>
												<td><span class="code_actvation-<?php echo $data->id_country;?>"><?php echo $view;?></span>
												<a  data-id="<?php echo $data->id_country;?>" class="btn btn-xs purple table-icon edit" title="change status" style="padding: 1px 0px;">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/update_country?id_type=<?php echo $data->id_country;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo base_url()?>admin/delete_country?id_type=<?php echo $data->id_country;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_country");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/check_view_country") ?>',
                type: 'POST',
                data: data,				
