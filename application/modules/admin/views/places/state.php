			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">State List</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?php echo $base_url?>admin/delete_state" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
										...
										<tbody>
                                        <?php
										 $tt=$this->db->get_where('state',array('type'=>'1'))->result();
										 if(count($tt)>0){
											...
											$country=$this->db->get_where('country',array('id_country'=>$country_id))->result();
											if(count($country)>0){
											 foreach($country as $countryid){
												 $country_title=$countryid->title;
											 }
											}
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input type="checkbox" class="checkboxes" value="<?=$data->id_state;?>" name="check[]" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->title;?> </td>
												<td><?=$country_title;?></td>
												<td><span class="code_actvation-<?php echo $data->id_state;?>"><?php echo $view;?></span>
												<a  data-id="<?php echo $data->id_state;?>" class="btn btn-xs purple table-icon edit" title="change status" style="padding: 1px 0px;">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/update_state?id_type=<?php echo $data->id_state;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo base_url()?>admin/delete_state?id_type=<?php echo $data->id_state;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_state");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/check_view_state") ?>',
                type: 'POST',
                data: data,				
