...
<form  method="post" action="pages_action" id="myform"  enctype="multipart/form-data">
...
<label class="control-label" for="firstname" style=" direction:rtl; float:right;font-family: 'Droid Arabic Kufi', sans-serif;">الاسم</label> <input class="form-control" id="password" name="categ_ar" type="text" style="width:100%; text-align:right; direction:rtl" required/></div>
...
<input type="submit" value="اضافة مجلة جديد" class="btn btn-primary fa fa-check-circle" id="Send"  style="font-family: 'Droid Arabic Kufi', sans-serif;">
