			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">Interests List</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">Interests List</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?php echo $dd?>admin/interests/delete" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input name="check[]" type="checkbox" class="checkboxes" value="<?=$data->id_interests;?>" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->title;?> </td>
												<td><span class="code_actvation-<?php echo $data->id_interests;?>"><?php echo $active;?></span>
												<a data-id="<?=$data->id_interests;?>" class="btn btn-xs purple edit" style="padding: 1px 0px;"><i class="fa fa-edit"></i></a>
												</td>
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo $dd?>admin/interests/edit?id=<?=$data->id_interests;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo $dd?>admin/interests/delete?id_interests=<?=$data->id_interests;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/interests/active") ?>',
		type: 'POST',
		data: data,				
