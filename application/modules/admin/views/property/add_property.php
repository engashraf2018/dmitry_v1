...
<div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo base_url()?>admin/property_action" class="form-horizontal form-bordered" method="post">
                                                    <div class="form-body">
                                                        <div class="form-group">
														<div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                                <input type="text" placeholder="Property type" class="form-control" name="property_type">
