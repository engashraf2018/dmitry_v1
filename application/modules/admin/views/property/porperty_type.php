							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">Property Type</span>
									</div>
								</div>
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input type="checkbox" class="checkboxes" value="<?=$data->id_list_type;?>" name="check[]" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->title;?> </td>
												
												<td><span class="code_actvation-<?php echo $data->id_list_type;?>"><?php echo $view;?></span>
												<a  data-id="<?php echo $data->id_list_type;?>" class="btn btn-xs purple table-icon edit" title="change status" style="padding: 1px 0px;">
