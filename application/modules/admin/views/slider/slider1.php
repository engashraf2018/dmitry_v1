												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/update_lisiting_type?id_type=<?php echo $data->id_list_type;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo base_url()?>admin/delete_lisiting_type?id_type=<?php echo $data->id_list_type;?>"><i class="fa fa-remove"></i> Delete </a></li>
