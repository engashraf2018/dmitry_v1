			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<span class="active">Slider List</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
						...
						<div class="col-md-12">
							...
							<div class="portlet light bordered">
								...
								<div class="portlet-body">
									...
									<form action="<?php echo $base_url?>admin/delete_slider" method="POST" id="form">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <?php
                                            foreach($results as $data) {
												...
												$image=$data->image;
												$img="../site/ar/images/slider/".$image;    
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input type="checkbox" class="checkboxes" value="<?=$data->id_slider;?>" name="check[]" />
														<span></span>
													</label>
												</td>
												...
												<td><span class="code_actvation-<?php echo $data->id_slider;?>"><?php echo $view;?></span>
												<a  data-id="<?php echo $data->id_slider;?>" class="btn btn-xs purple table-icon edit" title="change status" style="padding: 1px 0px;">
												...
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo base_url()?>admin/update_slider?id_type=<?php echo $data->id_slider;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo base_url()?>admin/delete_slider?id_type=<?php echo $data->id_slider;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
$(document).ready(function(e) {
    $(".addbutton").click(function(e) {
        window.location.assign("add_slider");
    });
});
</script>
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("admin/check_view_slider") ?>',
                type: 'POST',
                data: data,				
