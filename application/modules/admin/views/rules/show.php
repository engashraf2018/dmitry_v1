			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<li>
						...
						<li>
							<span class="active">Rules List</span>
						</li>
					</ul>
					<!-- END PAGE BREADCRUMB -->
							...
							<div class="portlet light bordered">
								<div class="portlet-title">
									<div class="caption font-dark">
										...
										<span class="caption-subject bold uppercase">Rules List</span>
									</div>
								</div>
								<span class="portlet-body">
									...
									<form action="<?php echo $dd?>admin/rules/delete" method="POST" id="form">
									<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        ?>
											<tr class="odd gradeX">
												<td>
													<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
														<input name="check[]" type="checkbox" class="checkboxes" value="<?=$data->id_Rules;?>" />
														<span></span>
													</label>
												</td>
												<td> <?=$data->name;?> </td>
												<td><span class="code_actvation-<?php echo $data->id_rules;?>"><?php echo $active;?></span>
												<a data-id="<?=$data->id_rules;?>" class="btn btn-xs purple edit" style="padding: 1px 0px;"><i class="fa fa-edit"></i></a>
												</td>
												<td>
													<div class="btn-group">
														...
														<ul class="dropdown-menu pull-left" role="menu">
															...
															<li><a href="<?php echo $dd?>admin/rules/edit?id=<?=$data->id_rules;?>"><i class="fa fa-pencil"></i> Edit </a></li>
															<li><a href="<?php echo $dd?>admin/rules/delete?id_Rules=<?=$data->id_rules;?>"><i class="fa fa-remove"></i> Delete </a></li>
...
var data={id:id};
	$.ajax({
		url: '<?php echo base_url("admin/rules/active") ?>',
		type: 'POST',
		data: data,				
