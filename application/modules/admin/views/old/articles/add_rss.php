...
<form  method="POST" action="<?php echo $dd?>home/rss_action" id="myform" enctype="multipart/form-data">
...
<input   name="site_name" type="text"   style="width:100%;    font-family: 'Droid Arabic Kufi', sans-serif;direction:rtl; height:40px;"/>
...
<label class=""  style="direction:ltr;    font-family: 'Droid Arabic Kufi', sans-serif; float:right">لينك الموقع</label>

<input   name="link" type="text"   style="width:100%;    font-family: 'Droid Arabic Kufi', sans-serif;direction:rtl; height:40px;"/>
...
<input   name="selector_name" type="text"   style="width:100%;    font-family: 'Droid Arabic Kufi', sans-serif;direction:rtl; height:40px;"/>
