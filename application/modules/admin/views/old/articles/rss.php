    ...
    $(".change").click(function(e) {
		...
		var data={id:id};
			...
			$.ajax({
				...
				url: '<?php echo base_url("home/check_view_rss") ?>',
...
$(document).ready(function(e) {
      ...
      $(".add").click(function(e) {
        ...
        window.location.assign("<?php echo $base_url?>home/add_rss");
...
<table class="dynamicTable scrollVertical table table-primary">
	...
	<thead>
        ...
        <th scope="col" class="center"><input type="checkbox" id="checkAll"></th>
            ...
            <th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">الموقع</th>
...
<form action="<?php echo $base_url?>home/delete_rss" method="POST" id="form">
...
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $jobs->site_name;?></td>
...
<a href="<?php echo $base_url?>home/delete_rss?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>

<a href="<?php echo $base_url?>home/update_rss?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
