...
$(document).ready(function(e) {
    $(".change").click(function(e) {
		...
		var data={id:id};
			$.ajax({
				url: '<?php echo base_url("home/check_view_authors") ?>',
                type: 'POST',
                // dataType: 'json',
                data: data,				
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("<?php echo $base_url?>home/add_writer");
    });
...
<table class="dynamicTable scrollVertical table table-primary">
	<thead>
        ...
        <th scope="col" class="center"><input type="checkbox" id="checkAll"></th>
            <th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">اسم الكاتب</th>
            <th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">الوصف</th>
            <th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">صورة</th>
...
<tbody>
<form action="<?php echo $base_url?>home/delete_writer" method="POST" id="form">
<?php
						?>
...
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $jobs->description;?></td>
...
<td class="center views-<?php echo $id_categ;?>" <?php if ($view == "1") {echo "style='color:green'";}else{echo "style='color:red'";	} ?> style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php if ($view == "1") {
	...
	<td class="center">
<a href="<?php echo $base_url?>home/delete_writer?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="<?php echo $base_url?>home/update_writer?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
