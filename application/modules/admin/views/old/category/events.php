    ...
    $(".change").click(function(e) {
		...
		var data={id:id};
			...
			$.ajax({
				...
				url: '<?php echo base_url("home/check_view_events") ?>',
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("<?php echo $base_url?>home/add_events");
    });
});
...
<td colspan="8" class="center" style="color:#E63998; font-size:18px">لا يوجد بيانات حاليا </td>
 ...
 $view=$jobs->views;
 $image=$jobs->img;
 $img="../../site/ar/images/events/".$image;    
...
<td class="center">
<a href="<?php echo $base_url?>home/delete_events?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="<?php echo $base_url?>home/update_events?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
