...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("home/check_view_passengers") ?>',
                type: 'POST',
                data: data,				
...
var data={id:id};
			$.ajax({
				url: '<?php echo base_url("home/check_view_pcode_actvation") ?>',
                type: 'POST',
                data: data,				
                success: function( data ) {
                	if (data == "1") {
...
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $jobs->address ;?></td>
