...
<div id="content">
  ...
  <div class="innerLR">
<div class="innerLR"> 
<form  method="POST" action="<?php echo $dd?>home/update_articles" id="myform" enctype="multipart/form-data">
 <input type="hidden" name="id" value="<?php echo $idhelp?>">
<div class="widget">
<div class="widget-body innerAll inner-2x">
<div class="form-group"  style="width:100%">
<label class=""  style="direction:rtl;    font-family: 'Droid Arabic Kufi', sans-serif; float:right">عنوان الخبر</label>
...
<textarea name="descriptioneng" rows="2" style="width:100%; direction:rtl;height:80px;"><?php echo $descriptioneng;?></textarea>
 ...
 <img src="../../site/ar/images/articles/<?php echo $img_site?>"  style="width:350px; height:200px;">
						...
						$gallery = $this->db->get_where("gallery_article",array("id_article"=>$this->input->get('id')))->result();
							...
							<div class="col-md-3" <?php if($link != ""){echo "style='display: none;'";} ?>>
								...
								<div class="old_img" style="position: relative">
									...
									<img style="width:80px;height: 50px;" src="../../site/ar/images/articles/<?php echo $gallery->img?>" alt="Product Image" />
