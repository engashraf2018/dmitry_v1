...
<div class="innerLR"> 
<!-- Form -->
<form  method="POST" action="<?php echo $dd?>home/video_action" id="myform" enctype="multipart/form-data">
<div class="widget">
...
<input   name="mapar" type="text"  placeholder="Ex:https://www.youtube.com/watch?v=LL59es7iy8Q"  style="width:100%;direction:ltr; height:40px;"/>
</div>
