...
$(document).ready(function(e) {
    $(".change").click(function(e) {
		...
		var data={id:id,view:view};
		 //alert(data);
		$.ajax({
				url: '<?php echo $base_url?>home/aboutrose_view',
                dataType:'json',
                data: data,	
				type:'POST',
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("<?php echo $base_url?>home/add_roseabout");
    });
...
<tbody>
<form action="<?php echo $base_url?>home/delete_aboutrose" method="POST" id="form">
<?php
						?>
...
<td class="center">
<a href="<?php echo $base_url?>home/delete_aboutrose?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="<?php echo $base_url?>home/update_roseabout?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
