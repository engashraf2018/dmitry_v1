...
$(document).ready(function(e) {
    $(".change").click(function(e) {
		...
		var data={id:id,view:view};
		 //alert(data);
		$.ajax({
				url: '<?php echo $base_url?>home/term_view',
                dataType:'json',
                data: data,	
				type:'POST',
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("add_term");
    });
...
<tbody>
<form action="delete_term" method="POST" id="form">
<?php
						?>
...
<td class="center">
<a href="delete_term?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="update_term?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
