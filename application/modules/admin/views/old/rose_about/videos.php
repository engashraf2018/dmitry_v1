...
$(document).ready(function(e) {
    $(".change").click(function(e) {
		...
		var data={id:id,view:view};
		 //alert(data);
		$.ajax({
				url: '<?php echo $base_url?>home/video_view',
                dataType:'json',
                data: data,	
				type:'POST',
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("<?php echo $base_url?>home/add_video");
    });
...
<table class="dynamicTable scrollVertical table table-primary">
	<thead>
        ...
        <th scope="col" class="center"><input type="checkbox" id="checkAll"></th>
            <th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">عنوان الفيديو</th>
             <th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">الفيديو</th>
...
<tbody>
<form action="<?php echo $base_url?>home/delete_video" method="POST" id="form">
<?php
						?>
...
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $jobs->name;?></td>
 <td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $link_video?></td>
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $view;?></td>
<td class="center">
<a href="<?php echo $base_url?>home/delete_video?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="<?php echo $base_url?>home/update_video?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
