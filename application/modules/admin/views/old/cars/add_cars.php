...
<div class="innerLR">
<div class="innerLR"> 
<form  method="POST" action="<?php echo $dd?>home/cars_action" id="myform" enctype="multipart/form-data">
<div class="widget">
...
?>
<div class="col-md-3">
<input type="checkbox" name="service_type[]" value="<?php echo $result_service->id;?>"><span style="margin-left:5px">
...
<input   name="title" type="text"  required style="width:100%;direction:rtl; height:40px;"/>
</div>
</div>
