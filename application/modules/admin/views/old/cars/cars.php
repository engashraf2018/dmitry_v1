...
$(".change").click(function(e) {
   var id = $(this).data("id");
		var data={id:id};
 $.ajax({
url: '<?php echo base_url("home/cars_view") ?>',
type: 'POST',
data: data,				
...
$(document).ready(function(e) {
      $(".add").click(function(e) {
        window.location.assign("<?php echo $base_url?>home/add_cars");
    });
});
</script>
...
<form action="<?php echo $base_url?>home/delete_cars" method="POST" id="form">
...
echo character_limiter($jobs->title,50);
 ;?></td>
 <td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php
echo character_limiter($jobs->titleeng,50);
 ;?></td>
  <td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php
...
<td class="center">
<a href="<?php echo $base_url?>home/delete_cars?id=<?php echo $id_categ;?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
<a href="<?php echo $base_url?>home/update_cars?id=<?php echo $id_categ;?>" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
