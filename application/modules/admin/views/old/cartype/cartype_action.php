...
$data['id_category'] = $service_type;
$data['descriptionar'] = $description;
$data['description'] = $descriptioneng;
$data['video'] = $video;
function gen_random_string()
{
 ...
 $insert = $this->db->insert('cartype',$data);
...
include('closedb.inc');
ob_flush();
header("location:".base_url()."home/cartype");
