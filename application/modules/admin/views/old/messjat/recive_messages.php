...
$sql = "SELECT SQL_CALC_FOUND_ROWS * from global_message where id_reciver='$prifix' and view='0' order by id desc limit $start,$per_page";
...
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $from;?></td>
...
{
$pr_page=$page-1;
echo '<a href="recive_messages?r='.$count.'&page='.$pr_page.'&shop_id='.$id_admin.'">«'.$prev.'</a>';							  
}
else
{
echo '<span>«'.$prev.'</span>';
...
{
echo '<a href="recive_messages?r='.$count.'&page='.$i.'&shop_id='.$id_admin.'">'.$i.'</a>';
}
}
