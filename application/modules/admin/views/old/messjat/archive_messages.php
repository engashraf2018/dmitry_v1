...
<th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">تاريخ الإرسال</th>
<th class="center" style="font-family: 'Droid Arabic Kufi', sans-serif; font-weight:400;">مرسلة من</th>
...
$sql = "SELECT SQL_CALC_FOUND_ROWS * from global_message where id_reciver='$prifix' and view='1' order by id desc limit $start,$per_page";
...
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $from." ( $user ) ";?></td>
<td class="center" style="font-family: 'Droid Arabic Kufi', sans-serif;"><?php echo $view;?></td>
<td class="center">
<a href="read_messages_m?id_messages=<?php echo $id_messages?>" class="btn btn-sm btn-success">
<i class="fa fa-eye"></i>
</a>
<a href="replay_messages_m?id_messages=<?php echo $id_messages?>" class="btn btn-sm btn-success">
...
{
$pr_page=$page-1;
echo '<a href="archive_messages?r='.$count.'&page='.$pr_page.'&shop_id='.$id_admin.'">«'.$prev.'</a>';							  
}
else
{
echo '<span>«'.$prev.'</span>';
...
{
echo '<a href="archive_messages?r='.$count.'&page='.$i.'&shop_id='.$id_admin.'">'.$i.'</a>';
}
}
