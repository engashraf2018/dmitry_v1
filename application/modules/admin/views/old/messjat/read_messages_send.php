...
$to=$contact_messages->id_reciver;
}
$ids = substr($to, 1);
$too=$to[0];
switch($too)
...
<div class="form-group col-md-2"></div> 
<div class="form-group col-md-8">
<label class="control-label" for="firstname" style=" direction:rtl; float:right;font-family:'Droid Arabic Kufi',sans-serif;">مرسلة إلي : 
</label> 
<label class="control-label" for="firstname" style=" direction:rtl; float:right;font-family:'Droid Arabic Kufi',sans-serif;">
 <?php echo $too." ( $user ) ";?>
</label> 
