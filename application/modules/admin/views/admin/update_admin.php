        ...
        <div class="page-container">
			...
			<div class="page-content" style="min-height: 1261px;">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
						...
						<li>
                        <a href="<?=$dd.'admin/team_work';?>">TeamWork List</a>
                        <i class="fa fa-circle"></i>
						</li>
                        <li>
...
<div class="tab-pane active" id="tab_5">
                                        ...
                                        <div class="portlet light bordered form-fit">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="<?php echo base_url()?>admin/update_admin_action" class="form-horizontal form-bordered"  method="post" enctype="multipart/form-data">
														...
														<div class="col-md-3" style="text-align:center"></div>
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
																			<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
																				<img src="<?php echo base_url()?>site/ar/images/site_setting/<?php echo $img?>" alt="" /> </div>
																			<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
																			<div>
																				<span class="btn default btn-file">
																					<span class="fileinput-new">profile image</span>
                                              ...
                                              <input type="text" placeholder="Email" class="form-control" name="mail" value="<?php echo $mail?>">
                                              ...
                                              <!--<span class="help-block"> This is inline help </span>-->
														...
														<div class="col-md-2"></div>
                                                            ...
                                                            <option value="">Please specify permission</option>
